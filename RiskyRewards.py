...
class RiskyRewards(gym.Env):
    ...
    GOAL: Implementing a simple RL environment consisting of a 2D grid world
          ...
          each one having a different reward distribution.
    ...
    def __init__(self, size=size):
        ...
        super(RiskyRewards, self).__init__()
        ...
        self.targetPosition0 = [int(self.size/2)-1, self.size-1]
        self.targetPosition1 = [int(self.size/2)+1, self.size-1]
    ...
    def step(self, action):
        ...
        if self.playerPosition == self.targetPosition0:  
            ...
            self.reward = np.random.normal(loc=-0.1, scale=0.1)
    ...
    def render(self, mode='human'):
        ...
        plt.show()
        #plt.savefig("RiskyRewardsEnvironment.pdf", format="pdf")
